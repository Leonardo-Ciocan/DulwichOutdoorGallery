    ...
    public static ArrayList<Art> Gallery = new ArrayList<Art>(){
        {
            add(new Art("Landscape with Sportsmen and Game, 2013" ,
                    ...
                    "Roa" , null , new ArrayList<String>(), 51.467437, -0.072308));

            add(new Art("Landscape with Windmills near Haarlem, 2014" ,
                    "" ,
                    "Walter Kershaw" , null , new ArrayList<String>(), 51.467357, -0.072510));

            add(new Art("Girl at a Window and The Triumph of David, 2013" ,
                    "This wall is a combnation of System's interpretation of 'Girl at a Window' by Rembrandt and Remi's interpretation of 'The Triumph of David' " +
                            "by Poussin." ,
                    "Remi Rough and System" , null , new ArrayList<String>(), 51.461959, -0.079336));
            ...
            add(new Art("The Nurture of Jupiter and Princess Victoria aged Four, 2013" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(), 51.461853, -0.077332));
            ...
            add(new Art("Fight Club, 2013" ,
                    ...
                    "Conor Harrington" , null , new ArrayList<String>(), 51.460617, -0.075041));

            add(new Art("" ,
                    "" ,
                    "Liqen" , null , new ArrayList<String>(), 51.456748, -0.071105));
            ...
            add(new Art("A Couple in a Landscape, 2012" ,
                    ...
                    "Stik" , null , new ArrayList<String>(), 51.456641, -0.075693));
            ...
            add(new Art("Mushroom Markers" ,
                    ...
                    "Christiaan Nagel " , null , new ArrayList<String>(), 51.455987, -0.076507));
            ...
            add(new Art("The Guardian Angel, 2012" ,
                    ...
                    "Stik" , null , new ArrayList<String>(), 51.456128, -0.077322));
            ...
            add(new Art("Girl with owl head and St. Sebastian, 2014" ,
                    ...
                    "Dscreet and Michael Beerens" , null , new ArrayList<String>(), 51.455987, -0.076507));
            ...
            add(new Art("New World Revolution, 2013" ,
                    ...
                    "Mear One 2013" , null , new ArrayList<String>(), 51.454564, -0.077177));
            ...
            add(new Art("Jacob with Laban and his Daughters, 2013" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(), 51.454536, -0.077439));
            ...
            add(new Art("The Triumph of David and The Nurture of Jupiter, 2013" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(), 51.453202, -0.077272));
            ...
            add(new Art("Art House, 2013" ,
                    ...
                    "Run, The Rolling People, Christiaan Nagel, Citizen Kane, Malarki, My Dog Sighs" , null , new ArrayList<String>(), 51.453037, -0.077218));
            ...
            add(new Art("The Fall of Man, 2012" ,
                    ...
                    "Stik" , null , new ArrayList<String>(), 51.453183, -0.078809));
            ...
            add(new Art("The Triumph of David, 2013" ,
                    ...
                    "Phlegm" , null , new ArrayList<String>(), 51.451588, -0.071564));
            ...
            add(new Art("White Horse in a Riding School, The Chaff-cutter and The Triumph od David, 2013" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(), 51.449772, -0.074846));

            add(new Art("Queen Bee on a Throne, 2013" ,
                    "" ,
                    "Nunca" , null , new ArrayList<String>(),51.449180, -0.074245));
            ...
            add(new Art("Jacob with Laban and his Daughters, Tha Chaff-cutter, The Nurture of Jupiter and Italian Landscape" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(), 51.448539, -0.073050));
            ...
            add(new Art("Elizabeth and Mary Linley, 2012" ,
                    ...
                    "Stik" , null , new ArrayList<String>(), 51.446656, -0.073634));

            add(new Art("St. Sebastian, 2014" ,
                    "" ,
                    "Beerens" , null , new ArrayList<String>(), 51.447706, -0.076339));
            ...
            add(new Art("Three Boys, 2012" ,
                    ...
                    "Stik" , null , new ArrayList<String>(), 51.445235, -0.078621));
            ...
            add(new Art("Joseph receiving Pharaoh's Ring, 2013" ,
                    ...
                    "Thierry Noir" , null , new ArrayList<String>(), 51.445275, -0.079029));
            ...
            add(new Art("Saint Catherine of Siena and The Judgement of Paris, 2013" ,
                    ...
                    "Ben Wilson" , null , new ArrayList<String>(), 51.445548, -0.085312));
            ...
            add(new Art("Dulwich Picture Gallery" ,
                    ...
                    "Dulwich Gallery" , null , new ArrayList<String>(), 51.445936, -0.086170));
            ...
            add(new Art("The Seven Corporal Works of Mercy, The Triumph of David, The Nurture of Jupiter and Peasants conversing, 2013" ,
                    ...
                    "Pablo Delgado" , null , new ArrayList<String>(),  51.445361, -0.087232));
            ...
            add(new Art("The Triumph of David, 2013" ,
                    ...
                    "RUN" , null , new ArrayList<String>(), 51.449647, -0.084786));
            ...
            add(new Art("Samson and Delilah, 2013" ,
                    "Discovering the painting by Anthony van Dick in Dulwich Picture Gallery, David saw the story coloured in and picked out some great visual " +
                            ...
                            "the onlookers." ,
                    "David Shillinglaw" , null , new ArrayList<String>(), 51.452870, -0.103013));
            ...
            add(new Art("Vase with Flowers, 2013" ,
                    ...
                    "Mad C" , null , new ArrayList<String>(), 51.441563, -0.091361));
            ...
            add(new Art("Europa and the Bull, 2013" ,
                    ...
                    "Reka" , null , new ArrayList<String>(), 51.427814, -0.086899));
            ...
            add(new Art("Happy Hour, 2013" ,
                    ...
                    "Agent Provocateur(AP)" , null , new ArrayList<String>(), 51.441069, -0.056676));
            ...
            add(new Art("The Translation of Saint Rita of Cascia, 2013" ,
                    ...
                    "RUN" , null , new ArrayList<String>(), 51.438862, -0.053918));

            add(new Art("Three Boys, 2013" ,
                    "" ,
                    "Michael Beerens" , null , new ArrayList<String>(), 51.447739, -0.074982));
        }
