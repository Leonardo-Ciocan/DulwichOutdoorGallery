    ...
    public static ArrayList<Art> Gallery = new ArrayList<Art>(){
        {
            add(new Art("Landscape with Sportsmen and Game, 2013" ,
                    ...
                    "Adam Pynacker" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.467437, -0.072308));
            ...
            add(new Art("Landscape with Windmills near Haarlem, 2014" ,
                    ...
                    "Jacob Van Ruisdael" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.467357, -0.072510));
            ...
            add(new Art("Girl at a Window and The Triumph of David, 2013" ,
                    "This wall is a combnation of System's interpretation of 'Girl at a Window' by Rembrandt and Remi's interpretation of 'The Triumph of David' " +
                            "by Poussin." ,
                    "Remi Rough and System" , null ,
                    new ArrayList<String>(), 51.461959, -0.079336));
            ...
            add(new Art("Fight Club, 2013" ,
                    ...
                    "Charles Le Brun" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.460617, -0.075041));
            ...
            add(new Art("A Couple in a Landscape, 2012" ,
                    ...
                    "Thomas Gainsborough" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.456641, -0.075693));
            ...
            add(new Art("The Guardian Angel, 2012" ,
                    ...
                    "Marcantonio Franceschini" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.456128, -0.077322));
            ...
            add(new Art("New World Revolution, 2013" ,
                    ...
                    "Bartolome Murillo" , null , new ArrayList<String>(), 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.454564, -0.077177));
            ...
            add(new Art("The Fall of Man, 2012" ,
                    ...
                    "Pieter Coecke van Aelst" , null , new ArrayList<String>(), 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.453183, -0.078809));
            ...
            add(new Art("The Triumph of David, 2013" ,
                    ...
                    "Nicolas Poussin" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.451588, -0.071564));
            ...
            add(new Art("Elizabeth and Mary Linley, 2012" ,
                    ...
                    "Thomas Gainsborough" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.446656, -0.073634));
            ...
            add(new Art("Three Boys, 2012" ,
                    ...
                    "Bartolome Esteban Murillo" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.445235, -0.078621));
            ...
            add(new Art("Joseph receiving Pharaoh's Ring, 2013" ,
                    ...
                    "Giambattista Tiepolo" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.445275, -0.079029));
            ...
            add(new Art("Saint Catherine of Siena and The Judgement of Paris, 2013" ,
                    ...
                    "Ben Wilson" , null ,
                    new ArrayList<String>(), 51.445548, -0.085312));
            ...
            add(new Art("The Triumph of David, 2013" ,
                    ...
                    "Nicolas Poussin" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.449647, -0.084786));
            ...
            add(new Art("Samson and Delilah, 2013" ,
                    ...
                    "Anthony van Dyck" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.452870, -0.103013));
            ...
            add(new Art("Vase with Flowers, 2013" ,
                    ...
                    "Jan van Huysum" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.441563, -0.091361));
            ...
            add(new Art("Europa and the Bull, 2013" ,
                    ...
                    "Guido Reni" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.427814, -0.086899));
            ...
            add(new Art("Happy Hour, 2013" ,
                    ...
                    "Sir Peter Paul Rubens" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.441069, -0.056676));
            ...
            add(new Art("The Translation of Saint Rita of Cascia, 2013" ,
                    ...
                    "Nicolas Poussin" , null , new ArrayList<String>() , 51.445936, -0.086170) ,
                    new ArrayList<String>(), 51.438862, -0.053918));
